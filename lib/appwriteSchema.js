...
export const SELF_REVIEW_STATUSES = {
  DRAFT: "draft",
  SUBMITTED: "submitted",
  REOPENED: "reopened",
};

export const GOAL_SELF_REVIEW_STATUSES = {
  DRAFT: "draft",
  SUBMITTED: "submitted",
};
...
export const NOTIFICATION_TRIGGER_TYPES = {
  ...
  SELF_REVIEW_WINDOW_OPENED: "self_review_window_opened",
  SELF_REVIEW_DEADLINE_REMINDER: "self_review_deadline_reminder",
  SELF_REVIEW_SUBMITTED: "self_review_submitted",
  SELF_REVIEW_SUBMITTED_MANAGER: "self_review_submitted_manager",
...
export const CYCLE_AUTO_APPROVAL_DEFAULTS = {
  ENABLED: false,
  DAYS: 7,
...
export const AI_POLICY_ROLES = {
  EMPLOYEE: "employee",
  MANAGER: "manager",
  HR: "hr",
};

export const AI_POLICY_FEATURE_TYPES = {
