...
export default function RegionAdminTeamAnalyticsPage() {
  ...
  const loadAnalytics = useCallback(async () => {
    ...
    try {
      ...
      setError(err instanceof Error ? err.message : "Unable to load region analytics.");
    } finally {
      setLoading(false);
    }
  }, []);
  ...
  }, [analyticsTimeFilter, departmentFilter, memberInfoById, orgGoals, selectedCycleId]);
  ...
  return (
    <Stack gap="4">
      <PageHeader
        ...
        subtitle={`Regional ranking and weighted performance graph for ${region || "your region"}.`}
        actions={
      ...
      <Card title="Regional Performance Analytics" description="Ranking based on weighted manager ratings and progress levels.">
        <Stack gap="3">
          <div className="flex flex-wrap items-center gap-2">
            <label className="caption text-[var(--color-text-muted)]" htmlFor="region-analytics-department-filter">
              Department
            </label>
            <select
              id="region-analytics-department-filter"
            ...
            <label className="caption text-[var(--color-text-muted)]" htmlFor="region-analytics-time-filter">
              Time
            </label>
            <select
              id="region-analytics-time-filter"
              className="rounded-[var(--radius-sm)] border border-[var(--color-border)] bg-[var(--color-surface)] px-2 py-1 body-sm text-[var(--color-text)]"
            ...
            {analyticsTimeFilter === "cycle" && (
              <>
                <label className="caption text-[var(--color-text-muted)]" htmlFor="region-analytics-cycle-filter">
                  Cycle
                </label>
                <select
                  id="region-analytics-cycle-filter"
                  className="rounded-[var(--radius-sm)] border border-[var(--color-border)] bg-[var(--color-surface)] px-2 py-1 body-sm text-[var(--color-text)]"
              ...
              <table className="min-w-full border-collapse">
                <thead>
                  <tr className="border-b border-[var(--color-border)]">
                    ...
                    <th className="px-2 py-2 text-left caption text-[var(--color-text-muted)]">Role</th>
                  ...
                  {analyticsRows.map((row) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-2 py-2 body-sm text-[var(--color-text-muted)]">{row.role}</td>
                        ...
                        <td className="px-2 py-2 body-sm text-[var(--color-text-muted)]">
